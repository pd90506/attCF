...
def fit():
    ...
    model_out_file = 'Pretrain/%s_gmf_%d_%s_%d.h5' %(args.dataset, mf_dim, args.layers, time())
    result_out_file = 'outputs/%s_gmf_%d_%s_top%d_%d.csv' %(args.dataset, mf_dim, args.layers, args.K, time())
