from user_genre_cf import get_model
import tensorflow.keras as keras
from tensorflow.keras import backend as K
import numpy as np
from time import time
from olddatasetclass import Dataset
from evaluate_genre_input import evaluate_model
...
def fit(args=Args()):
    ...
    for epoch in range(int(args.epochs)):
        ...
        dummy_genre = np.nan_to_num(dummy_genre)
         # Training
        hist = model.fit([np.array(user_input), dummy_genre], #input
